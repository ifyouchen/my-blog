...
public interface RewardGrantLogRepository {
     ...
     * @return 总数
     */
    long countForAdmin(Long userId, String userKeyword, String rewardType);
     ...
     * @return 记录列表
     */
    List<RewardGrantLog> findPageForAdmin(Long userId, String userKeyword, String rewardType, int offset, int limit);
}
