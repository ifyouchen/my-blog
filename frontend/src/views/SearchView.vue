...
useHead({
    title: computed(() => keyword.value ? `搜索: ${keyword.value} - 小蓝书` : '搜索 - 小蓝书')
});
...
<style scoped src="@/styles/views/SearchView.part-1.css"></style>
<style scoped src="@/styles/views/SearchView.part-2.css"></style>
<style scoped src="@/styles/views/SearchView.part-3.css"></style>
<style scoped src="@/styles/views/SearchView.part-4.css"></style>
