...
const pageTitle = computed(() => {
    if (article.value?.title) {
        return `${article.value.title} - 小蓝书`;
    }
    if (isLoading.value) {
        return '加载中 - 小蓝书';
    }
...
<style scoped src="@/styles/views/ArticleDetailView.part-1.css"></style>
<style scoped src="@/styles/views/ArticleDetailView.part-2.css"></style>
<style scoped src="@/styles/views/ArticleDetailView.part-3.css"></style>
<style scoped src="@/styles/views/ArticleDetailView.part-4.css"></style>
<style scoped src="@/styles/views/ArticleDetailView.part-5.css"></style>
<style scoped src="@/styles/views/ArticleDetailView.part-6.css"></style>
